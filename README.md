...
pixi global install lbapcommon
```
...
It is possible to list all of the versions of `lbapcommon` available on your platform:
...
```
pixi search lbapcommon --channel conda-forge
```
